...
void main() {
	char dirStr[]="B:\\Development\\Playground\\monitor";
	char dirFileStr[]="B:\\Development\\Playground\\monitor\\test1.txt";
	char dirFileStr2[]="B:\\Development\\Playground\\monitor\\test2.txt";
